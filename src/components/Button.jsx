...
function Button({ children, type, to, disabled, onClick }) {
  ...
  const styles = {
    ...
    secondary:
      base +
      "border-2 border-stone-300 text-sm focus:ring-stone-200 px-4  sm:px-6 md:py-3.5 hover:bg-[#c1c124] hover:text-stone-800 disabled:cursor-not-allowed uppercase font-semibold text-[#fff]  tracking-wide inline-block rounded-full focus:outline-none py-2.5 focus:ring focus:ring-yellow-300  focus:ring-offset-2 hover:bg-yellow-300 transition-all duration-300 ",
  };
