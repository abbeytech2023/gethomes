        ...
        <section className="grid items-center gap-12 px-6 py-20 md:px-20 md:grid-cols-2">
          ...
          >
            ...
            <p className="text-lg leading-relaxed">
              ...
              story and every artisan deserves recognition. We specialize in
              real estate services, helping clients buy, sell, or rent
              properties with confidence. At the same time, we provide a
              platform for skilled artisans and technicians to showcase their
              work, making it easier for clients to access trusted services.
            </p>
          </motion.div>
          <motion.div
